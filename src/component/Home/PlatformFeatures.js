...
const PlatformFeatures = () => {
  return (
    <section className="py-8 md:py-20 bg-cover bg-center" style={{ backgroundImage: 'url("https://images.pexels.com/photos/1509607/pexels-photo-1509607.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")' }}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden p-4 md:p-6 transition-transform transform hover:scale-105">
        ...
        <div className="flex justify-center mt-8 md:mt-12">
          <button className="px-4 md:px-6 w-40 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 transition duration-300">
            Register Now
          </button>
        </div>
      </div>
