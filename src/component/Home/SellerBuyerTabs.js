    ...
    <section className="py-8">
      <div className="container mx-auto px-4">
        <div className="max-w-screen-xl mx-auto md:px-8">
          <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-lg shadow-lg overflow-hidden">
            {/* Heading */}
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 py-2 px-6 rounded-t-lg text-center">
              ...
              <div className="flex space-x-4">
                <label className="flex items-center cursor-pointer">
                  ...
                  <span
                    ...
                    } flex items-center justify-center h-10 px-6 text-sm font-medium rounded-md`}
                  >
                    Buyer
                  </span>
                </label>
            ...
            <div className="bg-white rounded-b-lg shadow-lg overflow-hidden p-6">
              <form className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                  ...
                  <button
                    type="submit"
                    className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-md mt-4 focus:outline-none focus:ring focus:ring-yellow-500 focus:border-yellow-500 w-full"
                  >
                    Submit
                  </button>
                </div>
