...
const CustomerSideBar = () => {
  ...
  return (
    <div className="flex flex-col w-80 bg-gray-900 text-white h-screen py-6 shadow-lg">
      <div className="mb-8 text-center text-2xl font-bold">
        <Link to="/">
          <img src="../assets/img/logo/logo.png" alt="logo" className="h-10 mx-auto" />
        </Link>
      </div>
      <ul className="flex-grow space-y-4">
        <li className="relative group">
          <Link
            ...
            className={`flex items-center p-3 rounded-lg ${isActive('/customer/add-product') ? 'bg-yellow-900' : 'bg-gray-800'
