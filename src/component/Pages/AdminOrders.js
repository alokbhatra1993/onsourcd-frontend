                        ...
                        {orders.length > 0 ? (
                            orders.map((order) => (
                                <tr key={order._id} className="hover:bg-gray-200 transition duration-300">
                                    <td className="py-3 px-1 border border-gray-300 text-blue-500 underline" title={order?._id}>{order?._id.slice(0,3)}...</td>
                                    <td className="py-3 px-1 border border-gray-300 text-blue-500 underline" title={order?.requirementId}>{order?.requirementId.slice(0,3)}...</td>
                                    <td className="py-3 px-1 border border-gray-300 text-blue-500">{order.quotationId.slice(0,3)}...</td>
                                    <td className="py-3 px-1 border border-gray-300 text-black">{order?.estimatedPrice}</td>
                                    ...
                                    {/* <td className="py-3 px-1 border border-gray-300 text-black">{order.expectedStartDate}</td>
                                    <td className="py-3 px-1 border border-gray-300 text-black">{order.expectedEndDate}</td> */}
                                </tr>
                            ))
                        ) : (
                            <tr>
                                <td colSpan="11" className="py-3 px-1 text-center text-gray-500 border border-gray-300">No orders found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
