    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-6 sm:py-0 sm:px-6">
      <div className="sm:flex sm:justify-center sm:items-center">
        ...
        <div className="hidden sm:flex sm:w-1/3 sm:ml-4 bg-cover bg-center"
             style={{ backgroundImage: `url('https://images.unsplash.com/photo-1595569099963-77bf7706643a?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`, height: '43rem' }}>
        </div>
      </div>
    </div>
  );
